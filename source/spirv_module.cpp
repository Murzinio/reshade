...
spv::Id spirv_module::add_binary_operation(spirv_basic_block &block, const location &loc, tokenid op, const type &res_type, const type &type, spv::Id lhs, spv::Id rhs)
{
	...
	case tokenid::plus:
	case tokenid::plus_equal: spvop = type.is_floating_point() ? spv::OpFMul : spv::OpIAdd; break;
	case tokenid::minus:
	case tokenid::minus_equal: spvop = type.is_floating_point() ? spv::OpFMul : spv::OpISub; break;
	case tokenid::slash:
